...
export default function CoacheeMessages() {
  ...
  const conversations = React.useMemo(() => {
    ...
    allMessages.forEach(msg => {
      ...
      const otherName = msg.sender_id === user.id ? 
        (msg.receiver_id === user.id ? msg.sender_name : "Coach") : 
        msg.sender_name;
    ...
    <div className="p-6 md:p-8 bg-gradient-to-br from-gray-50 to-indigo-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">Comunica in tempo reale con i tuoi coach</p>
        </motion.div>
              ...
              {!selectedConversation ? (
                <div className="h-[600px] flex items-center justify-center text-gray-500 bg-gradient-to-br from-gray-50 to-indigo-50">
                  <div className="text-center">
                    ...
                    <p className="text-sm">Inizia a chattare con i tuoi coach</p>
                  </div>
                </div>
              ) : (
